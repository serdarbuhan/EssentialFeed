...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    func test_save_doesNotDeliversDeletionError_AfterSUTInstanceHasBeenDeallocated() {
    ...
    func test_save_doesNotDeliversInsertionError_AfterSUTInstanceHasBeenDeallocated() {
        let store = FeedStoreSpy()
        var sut: LocalFeedLoader? = LocalFeedLoader(store: store, currentDate: Date.init)
